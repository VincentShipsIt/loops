...
- For a safe fix, create a fresh `[BRANCH_PREFIX]-commit-review-YYYYMMDD-HHMMSS` branch with no upstream directly from `default_commit` in the isolated worktree.
