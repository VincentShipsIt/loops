...
- Read the issue body and comments, repository instructions, relevant architecture and documentation, and nearby code before editing. Repository-specific safety and domain rules in `AGENTS.md` are binding.
...
Publish for review:
- Commit with the issue number, push the branch, and open a pull request against `[TRUNK]`.
